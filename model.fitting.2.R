...
#Fit BRM scaled----
perennial_lambda <- brm(bf(out_p ~ lambdaP*5000 / (1+alphaPA*seeded_a + alphaPP*density_p), 
...
#Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#lambdaP_Intercept       1.29      0.33     0.90     1.98 1.33        7      299
#lambdaP_warmtrtwarm     0.47      0.40     0.01     1.00 1.78        4       12
#alphaPA_Intercept       0.00      0.01    -0.00     0.01 1.21       13       40
#alphaPA_warmtrtwarm     0.00      0.00    -0.00     0.01 1.31        7       80
#alphaPP_Intercept      -0.01      0.04    -0.08     0.07 1.75       69      163
#alphaPP_warmtrtwarm     0.08      0.07     0.00     0.23 1.74        5       13
